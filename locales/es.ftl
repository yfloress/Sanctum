...
import-exchange-supported = Soportados: Kraken, Binance, MEXC, Feather Wallet, Monero GUI Wallet
...
import-exchange-not-detected = No se pudo detectar el formato del exchange. Soportados: Kraken, Binance, MEXC, Feather Wallet, Monero GUI Wallet.
...
import-exchange-hint-kraken = Exportar desde Kraken: Documentos > Seleccionar Ledgers CSV
import-exchange-hint-kraken-pro = Exportar desde Kraken Pro: History > Statements > Seleccionar Ledger CSV
