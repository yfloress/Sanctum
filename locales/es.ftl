...
crypto-tax-readiness-settings-warn-detail = No se encontraron transacciones en el período comercial calculado. En Chile, el Ano Tributario 2026 usa transacciones 2025. Revisa el período, las billeteras excluidas y los archivos importados.
...
crypto-tax-readiness-prices-fx = Normalizar operaciones con precio FX
...
crypto-tax-readiness-prices-fx-warn = {$count} elementos usan cotización no-USD
crypto-tax-price-sync-running = La sincronización de precios ya está en curso
crypto-tax-price-sync-no-missing = No hay precios faltantes por sincronizar
crypto-tax-price-sync-finished = Se sincronizaron {$count} precios faltantes
crypto-tax-price-sync-unresolved = {$count} elementos no se pudieron resolver automáticamente
