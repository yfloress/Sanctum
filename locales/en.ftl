...
import-exchange-hint-notbank = NotBank (CryptoMarket): Exchange Pro > Reports > Single Report > Transaction, Trade Activity, and Profit and Loss (you can upload all three together).
