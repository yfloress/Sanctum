...
crypto-tax-readiness-history-warn-suffix = disposals with insufficient lots
crypto-tax-readiness-prices-invalid-suffix = Invalid dates or types found
crypto-tax-readiness-prices-warn-suffix = items missing price data
crypto-tax-readiness-transfers-warn-suffix = unpaired transfers
crypto-tax-readiness-balances-warn-detail = Some disposals exceed available lot quantity
crypto-tax-readiness-sii-gain-detail = Gain → F22 Line 10, Casilla 1032. ⚠ Casilla codes may change each year.
crypto-tax-readiness-sii-loss-detail = Loss → F22 Line 17, Casilla 169 (capped). ⚠ Casilla codes may change each year.
crypto-tax-readiness-sii-neutral-detail = No net gain or loss. ⚠ F22 casilla codes may change each year.
...
crypto-tax-readiness-sii-gain = Gain → F22 Line 10, Casilla 1032. ⚠ Casilla codes may change each year.
crypto-tax-readiness-sii-loss = Loss → F22 Line 17, Casilla 169 (capped at casillas 105+155+152+1032+1891+1104). ⚠ Casilla codes may change each year.
crypto-tax-readiness-sii-neutral = No net gain or loss. ⚠ F22 casilla codes may change each year.
...
modal-tax-type = TAX CATEGORY
modal-tax-type-placeholder = trade / income / expense / transfer
modal-tax-subtype = TAX SUBTYPE
modal-tax-subtype-placeholder = airdrop / staking / fee / other
