...
crypto-tax-readiness-settings-warn-detail = No transactions found in the computed commercial period. In Chile, Tax Year 2026 uses 2025 transactions. Review period selection, wallet exclusions, and imported files.
