...
# ==================== Credits ====================
finances-credits = Credits
finances-credits-desc = Debts you pay off over a fixed number of dated payments. Marking one as paid writes the expense into the account it comes out of.
finances-credit-new = New
finances-credit-name = What did you buy?
finances-credit-installment = Amount per installment
finances-credit-count = How many
finances-credit-first-due = First one due on
finances-credit-cash-price = Price if you paid it all at once (optional)
finances-credit-total = Total
finances-credit-extra = You pay {$amount} more than the thing costs
finances-credit-added = Credit saved
finances-credit-deleted = Credit deleted
finances-credit-delete-confirm = Delete this credit? Payments already made stay in your ledger.
finances-no-credits = No credits yet.
finances-credit-installments = installments
finances-credit-left = left
finances-credit-next = Next
finances-credit-interest = Interest
finances-credit-done = Finished
finances-credit-overdue = Overdue: {$count}
finances-credit-ahead = Ahead of schedule
finances-credit-on-track = Up to date
finances-credit-pay = Pay {$amount}
finances-credit-pay-short = Pay
finances-credit-undo = Undo
finances-credit-paid = Installment paid
finances-credit-undone = Payment undone
finances-credit-show-schedule = Schedule
finances-credit-hide-schedule = Hide schedule
finances-credit-inst-paid = Paid
finances-credit-inst-overdue = Overdue
finances-credit-inst-pending = Pending

finances-credit-kind-installments = They told me the payment
finances-credit-kind-loan = They told me the rate
finances-credit-down-payment = Down payment
finances-credit-down-payment-optional = Paid up front (optional)
finances-credit-down-payment-date = Handed over on
finances-credit-principal = Amount financed
finances-credit-rate = Interest rate (%)
finances-credit-rate-period = Quoted as
finances-credit-rate-monthly = Monthly
finances-credit-rate-annual = Annual
finances-credit-rate-monthly-short = monthly
finances-credit-suggested = Calculated from the rate. If your contract says something else, type that instead.
finances-credit-pay-next = Pay next
finances-credit-edit = Edit
finances-credit-edit-title = Correct this installment
finances-credit-edit-desc = For a plan whose payments are not all equal: a larger final one, a skipped month, a figure that came out different.
finances-credit-updated = Installment updated
finances-credit-due-date = Due on
finances-credit-charge = Charge
finances-credit-charges = Charges
finances-credit-add-charge = Add charge
finances-credit-charge-title = Record a charge
finances-credit-charge-desc = A late fee or interest the lender added. Enter what they actually charged you: the rules and figures behind it differ by country and by lender, so this app does not guess at them.
finances-credit-charge-amount = Amount charged
finances-credit-charge-note = What was it for?
finances-credit-charge-added = Charge recorded
finances-credit-breakdown = Breakdown
finances-credit-col-payment = Payment
finances-credit-col-interest = Interest
finances-credit-col-principal = Principal
finances-credit-col-balance = Still owed
finances-save = Save
# ==================== Activity Sorting ====================
