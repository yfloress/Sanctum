...
import-exchange-supported = Supported: Kraken, Binance, MEXC, Feather Wallet, Monero GUI Wallet
...
import-exchange-not-detected = Could not detect exchange format. Supported: Kraken, Binance, MEXC, Feather Wallet, Monero GUI Wallet.
...
import-exchange-hint-kraken = Kraken: Documents > Select Ledgers CSV
import-exchange-hint-kraken-pro = Kraken Pro: History > Statements > Select Ledger CSV
import-exchange-hint-binance = Export from Binance: Orders > Transaction History > Generate All Statements
import-exchange-hint-mexc = Export from MEXC: Orders > Spot Order > Trade History > Export
