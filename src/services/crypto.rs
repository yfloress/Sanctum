...
//!
//! Provides CryptoService for managing crypto wallets, transactions, and portfolio.
//! API functions are now in features/crypto/api.rs
...
pub use crate::features::crypto::api::{
