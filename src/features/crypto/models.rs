...
//!
//! Contains CryptoWallet, CryptoTransaction, CryptoAsset, and related types.
...
impl CryptoTransactionType {
    ...
    pub fn is_inflow(&self) -> bool {
        matches!(self, CryptoTransactionType::Buy | CryptoTransactionType::TransferIn)
    }

    pub fn is_outflow(&self) -> bool {
        matches!(self, CryptoTransactionType::Sell | CryptoTransactionType::TransferOut)
    }
}
...
impl CryptoTransaction {
    ...
    pub fn validate(&self) -> bool {
        !self.wallet_id.is_empty()
            ...
            && self.amount > 0.0
            && self.transaction_type.parse::<CryptoTransactionType>().is_ok()
    }
