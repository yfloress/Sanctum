...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::finance::fetch_tags,
            commands::finance::tag_transactions,
            commands::finance::fetch_reconciliation,
            commands::finance::confirm_reconciliation,
            ...
            commands::finance::fetch_credits,
            commands::finance::add_credit,
            commands::finance::delete_credit,
            commands::finance::pay_installment,
            commands::finance::unpay_installment,
            commands::finance::update_installment,
            commands::finance::add_credit_charge,
            commands::finance::delete_credit_charge,
